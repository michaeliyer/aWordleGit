...
function updateFooter() {
  ...
  document.getElementById("countdownToMidnight").textContent = `Countdown to Goddamn Midnight: 🧌 ${getTimeUntilMidnightEastern()} Dear All You Good Clocks Out There: Thou Clockest Can't Tick Fast Enough! With no due respect, you make me want to self-mutilate, GOP!`;
}
...
function updateCountdown() {
  ...
  if (countdownElement) {
    countdownElement.textContent = `Los Americanos Mid-Term Electionés 0f 2026: ${calculateCountdown("2026-11-03T00:00:00")}. 
    Wilt We Goddamn MotherFucking Maketh Her, Thou Jerkoes, Thoust Dastardly Nastardly Bastardly Castaway Fools? Likely, We Art Completethly Fucketh? What Dost Sayeth Thou? I sayeth yea!`;
  }
}
