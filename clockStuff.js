...
function updateFooter() {
  ...
  document.getElementById("countdownToMidnight").textContent = `Countdown To Our Goddamn Midnight Hour: 🧌 ${getTimeUntilMidnightEastern()} Dear All You Good Clocks, Etc. Out There: Thou Clockest Can't Tick Fast Enough! With no due respect, you make me want to self-mutilate, GOP!`;
}
