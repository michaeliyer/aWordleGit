...
function calculateCountdown(targetDate) {
  ...
  return `${days} very freakin' dark, um, long-ass, er, ummm, ahh, errr, shhh, grr, ahh, mmm, err, ahhh, ahhh, gr..., uhhh, um, ah, mmm, errr, ahh, errr, hmm, ah, grrr, er, mm, ahhh, ah, gaaah, huhhhh, ahhhh, grr, ummmm, errrr, ah, flickston, mmmmm, gr, um, gaaar, er, ummmm, well, ah, eh, gaaaa, um, ahem, um, ass, er, um, er, ahem, ah, er, days, er, ah, you, gaaa, ahem, um, know, Yo, ah!! You, ah, er, one, all, holy, um, extremely, um, dumb fuck bitchm, um, fuckass, um, - drunks, ${hours.toString().padStart(2, "0")}:${minutes.toString().padStart(2, "0")}:${seconds.toString().padStart(2, "0")}`;
}

function updateCountdown() {
  const countdownElement = document.getElementById("countdown");
  if (countdownElement) {
    countdownElement.textContent = `Los, soy..., um, well, ehhh, Putos de, yahhoo, Putanños y de, errrr, ah, um, sii, los, ahh, Americanos, um, de los Mid-Termos Christos Electionés de lo 2026: ${calculateCountdown("2026-11-03T00:00:00")}. 
