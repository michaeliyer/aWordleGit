...
function updateFooter() {
  ...
  document.getElementById("countdownToMidnight").textContent = `Here's, um, Our Own Good Goddamn Mother Christing Effing Effed Up Soily Garbage Effing Countdown To Your Goddamn Stupid Idiotic Goddamn Fuckin' Midnight Hour: 🧌 ${getTimeUntilMidnightEastern()} Dear All You Good Clocks, Etc. Out There: Thou Clockest Can't Ticketh Fast Enough! With no due respect, you make me want to self-mutilate, GOP! You know you're morons. Maybe just jump to your deaths!`;
}
...
function calculateCountdown(targetDate) {
  ...
  return `${days} very freakin' dark, long-ass flickston ass days, you know, Yo!! You, one, all, holy extremely dumb fuck bitch fuckass - drunks, ${hours.toString().padStart(2, "0")}:${minutes.toString().padStart(2, "0")}:${seconds.toString().padStart(2, "0")}`;
}

function updateCountdown() {
  const countdownElement = document.getElementById("countdown");
  if (countdownElement) {
    countdownElement.textContent = `Los Putos de Putanños y de los Americanos de los Mid-Termos Christos Electionés de lo 2026: ${calculateCountdown("2026-11-03T00:00:00")}. 
