...
function updateFooter() {
  ...
  document.getElementById("countdownToMidnight").textContent = `Countdown To This Goddamn Midnight Hour: 🧌 ${getTimeUntilMidnightEastern()} Dear All You Good Clocks, Etc. Out There: Thou Clockest Can't Tick Fast Enough! With no due respect, you make me want to self-mutilate, GOP!`;
}
...
function updateCountdown() {
  ...
  if (countdownElement) {
    ...
    Wilt We Goddamn MotherFucking Maketh Her, Thou Jerkoes, Thoust full Dastardly Nastardly Bastardly Castaway Wasterly Foolinoidal Tool? Likely, We Arteth Completethly Fucketh? What Dost Sayeth Thou? I sayeth yea!`;
  }
}
