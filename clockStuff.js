...
function updateFooter() {
  ...
  document.getElementById("countdownToMidnight").textContent = `The Effing Effed Up Garbage Countdown To Your Stupid Idiotic Goddamn Fuckin' Midnight Hour: 🧌 ${getTimeUntilMidnightEastern()} Dear All You Good Clocks, Etc. Out There: Thou Clockest Can't Ticketh Fast Enough! With no due respect, you make me want to self-mutilate, GOP! You know you're morons. Maybe just jump to your deaths!`;
}
