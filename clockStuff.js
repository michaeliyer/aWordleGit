...
function updateFooter() {
  ...
  document.getElementById("countdownToMidnight").textContent = `Here's, um, Our Own Good, um, Goddamn Mother, um, Christing Effing, um, Effed Up Soily Garbage Effing Countdown To Your Goddamn Stupid Idiotic Goddamn Fuckin' Midnight Hour: 🧌 ${getTimeUntilMidnightEastern()} Dear All You Good Clocks, Etc. Out There: Thou Clockest Can't Ticketh Fast Enough! With no due respect, you make me want to self-mutilate, GOP! You know you're morons. Maybe just jump to your deaths!`;
}
...
function calculateCountdown(targetDate) {
  ...
  return `${days} very freakin' dark, um, long-ass flickston, um, ass days, you, um, know, Yo!! You, one, all, holy, um, extremely, um, dumb fuck bitch fuckass, um, - drunks, ${hours.toString().padStart(2, "0")}:${minutes.toString().padStart(2, "0")}:${seconds.toString().padStart(2, "0")}`;
}
...
function updateCountdown() {
  ...
  if (countdownElement) {
    ...
    Wilst We Goddamn MotherFucking Maketh Her, It, That, um, Thou, Los, Um, Jerkoes, Lo, Thoust Fulleth andeth Dastardly Nastardly and Bastardly Castaway Wasterly Foolinoidal Toolions? Likethly, We Arteth Completethly Fucketh? What Dost Sayeth Thou? I sayeth yea, fuckethstroid! Licketh off pleaseth thou. Ah, the hate...You see thgat?`;
  }
}
