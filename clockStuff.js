...
function updateFooter() {
  ...
  document.getElementById("countdownToMidnight").textContent = `Countdown to Goddamn Midnight: 🧌 ${getTimeUntilMidnightEastern()} Dear Good Clocks: Thou Clockest Can't Tick Fast Enough! With no due respect, you make me want to die, GOP!`;
}
...
function updateCountdown() {
  ...
  if (countdownElement) {
    ...
    Will We Goddamn MotherFucking Make Her, Thou Jerkoes, Thou Dastardly Fools? Likely We Art Fucketh? What Dost Sayeth Thou? I sayeth yea!`;
  }
}
