...
function updateFooter() {
  ...
  document.getElementById("countdownToMidnight").textContent = `Countdown To That Goddamn Fuckin' Midnight Hour: 🧌 ${getTimeUntilMidnightEastern()} Dear All You Good Clocks, Etc. Out There: Thou Clockest Can't Tick Fast Enough! With no due respect, you make me want to self-mutilate, GOP!`;
}
...
function updateCountdown() {
  ...
  if (countdownElement) {
    countdownElement.textContent = `Los Putos Americanos Mid-Termos Electionés de 2026: ${calculateCountdown("2026-11-03T00:00:00")}. 
    Wilst We Goddamn MotherFucking Maketh Her, Thou Jerkoes, Thoust fulleth Dastardly Nastardly Bastardly Castaway Wasterly Foolinoidal Toolions? Likethly, We Arteth Completethly Fucketh? What Dost Sayeth Thou? I sayeth yea!`;
  }
}
