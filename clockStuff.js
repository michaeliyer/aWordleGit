...
function calculateCountdown(targetDate) {
  ...
  return `${days} very freakin' dark, long-ass flick ass days, you know, Yo!! You holy extremely dumb fuck bitch fuckass drunks, ${hours.toString().padStart(2, "0")}:${minutes.toString().padStart(2, "0")}:${seconds.toString().padStart(2, "0")}`;
}
