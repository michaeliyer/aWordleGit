...
function updateFooter() {
  ...
  document.getElementById("countdownToMidnight").textContent = `Countdown to Goddamn Midnight: 🧌 ${getTimeUntilMidnightEastern()} Dear All Good Clocks: Thou Clockest Can't Tick Fast Enough! With no due respect, you make me want to die, GOP!`;
}
