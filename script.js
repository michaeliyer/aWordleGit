...
function displayResults(results) {
  ...
  const listWithTotal = `${wordsList} (${totalWords} Christing idiotic words exist in this unlit frickin' list, assholes!! It's steadily shrinking, like my sanity, DICKLORD!)`;
