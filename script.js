...
//       foundWord.gameDate
//     )
//     const resultString = `'${foundWord.word}': That, errr, ah, um, uh, fuu..., fu, ahh, um, off, ahhh, you, ahh, get it, most, ah, well, er, uh, well, mmm, err, retardally, er, ah, ahem, gaa, um, idiotical, er, um, WORD was so abso-fuckin-um-lutely fuckin' ALREADY Goddamn FUCKING em-fuckin'-ployed by this Pissing Ass Wordle affair (as I've said! Repeatedly! Listen!) on ${foundWord.gameDate}. Goddamn you Ace! <br> It was word #${foundWord.wordNumber}, 
...
function applyFilter(selectedFunction, letter, position) {
  switch (selectedFunction) {
    ...
    default:
      alert(
        "Please select, ah, a valid, gerrr, function, ahhh, you, er, um, ahh, errr, goddamn, oh, gaaaa, ahhh, er, ahhh, um, stupid, duhhh, ah, stupid, um, er, asshole."
      );
      return;
  }
}
...
calculateAverageButton.addEventListener("click", () => {
  ...
  averageScoreResult.textContent = `Your Average Score - (You, ah, smell, er, really, ahh, mm, er, er, um, much, grr, ahem, ah, er, and, ah, y'know, um, continuously, um, like cockshit, Cocklick! Um, Cocklord! Cumlick!) - betweeneth words #${start} & #${end} = a gd, a-f-ing 'damn crisp-ass, um, dick-shitting ${averageScore.toFixed(
    6
