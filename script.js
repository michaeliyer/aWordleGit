...
function handleWordInput() {
  ...
  if (foundWord) {
    ...
    const resultString = `'${foundWord.word}': ALREADY Goddamn FUCKING employed by Wordle (as I've said! Repeatedly!) on ${foundWord.gameDate}.<br> It was word #${foundWord.wordNumber}, 
