...
function displayResults(results) {
  ...
  const listWithTotal = `${wordsList} (${totalWords}, um, er, Christing, ah, um, †‡ and, ah, well, ah, dick, um, yeah, um, oh ho, gagging, um, grossly, um, outwardly, blatantly, fantastically, errrr, idiotical, eh, and, um, goddamn, ahem, cunting †‡ stupid ass frickin' fuckin' AssHole 🧌 🧌 🧌  Fuckin' Words stupidestly exist stupidly and Parasitically, um, in this here unlit motherfrickin' list, assholes!! It's steadily shrinking, dickLicks, like my sanity, DICKLORD!)`;
...
function applyFilter(selectedFunction, letter, position) {
  switch (selectedFunction) {
    ...
    case "containsDuplicateLetters":
      ...
      break;
    default:
      alert("Please select, ah, a valid function, you, er, goddamn, um, stupid, ah, stupid, um, er, asshole.");
      return;
  }
}
