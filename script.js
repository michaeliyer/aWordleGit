...
function handleWordInput() {
  ...
  if (foundWord) {
    ...
    const notFoundString = `The word "${inputWord}", which is an innocent bystander, was notteth found, wretched Whores and Assfucks, making Rand Paul that rapist. Hit that fuck again neighbor. Shut up, but<br> feel free, feel obligated, to guess the word "${inputWord}", Fuckface!`;
