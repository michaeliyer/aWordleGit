...
function displayResults(results) {
  ...
  const listWithTotal = `${wordsList} (${totalWords} Christing †‡ idiotical cunting †‡ stupid ass frickin' fuckin' AssHole 🧌 🧌 🧌  Fuckin' Words stupidestly exist stupidly and Parasitically in this here unlit motherfrickin' list, assholes!! It's steadily shrinking, dickLicks, like my sanity, DICKLORD!)`;
