...
calculateAverageButton.addEventListener("click", () => {
  ...
  averageScoreResult.textContent = `Your Average Score - (You smell really, um, much and continuously, um, like cockshit, Cocklick! Cocklord! Cumlick!) - betweeneth words #${start} & #${end} = a gd, a-f-ing 'damn crisp-ass dick-shitting ${averageScore.toFixed(
    6
