...
function applyFilter(selectedFunction, letter, position) {
  switch (selectedFunction) {
    ...
    case "containsDuplicateLetters":
      ...
      break;
    default:
      alert("Please select, ah, a valid function, you goddamn, um, stupid, ah, stupid, um, asshole.");
      return;
  }
}
...
calculateAverageButton.addEventListener("click", () => {
  ...
  averageScoreResult.textContent = `Your Average Score - (You smell, er, really, um, much, er, and, um, continuously, um, like cockshit, Cocklick! Um, Cocklord! Cumlick!) - betweeneth words #${start} & #${end} = a gd, a-f-ing 'damn crisp-ass, um, dick-shitting ${averageScore.toFixed(
    6
