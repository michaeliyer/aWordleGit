...
calculateAverageButton.addEventListener("click", () => {
  ...
  averageScoreResult.textContent = `Average Score - (You smell like shit, Cocklick!) - between words #${start} & #${end} = a gd, a-f-ing 'damn crispAss shitting ${averageScore.toFixed(
    6
  )}, You Cocksucker!`;
});
