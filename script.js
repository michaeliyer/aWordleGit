...
function displayResults(results) {
  ...
  const listWithTotal = `${wordsList} (${totalWords} Christing idiotic stupidWords exist in this here unlit frickin' list, assholes!! It's steadily shrinking, like my sanity, DICKLORD!)`;
