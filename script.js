...
const oldWords = [
  ...
  let newWords = [
        ...
        'BIDDY', 'BIGOT', 'BILGE', 'BILLY', 'BINGO', 'BISON', 'BITTY', 'BLADE', 'BLANK', 
        'BLAST', 'BLEAT', 'BLEND', 'BLESS', 'BLIMP', 'BLIND', 'BLINK', 'BLISS', 'BLITZ',
        ...
        'CRUEL', 'CRUMP', 'CRYPT', 'CUBIC', 'CURIO', 'CURRY', 'CURSE', 'CURVE', 'CURVY',
        'CUTIE', 'CYBER', 'CYCLE', 'DAILY', 'DAIRY', 'DALLY', 'DATUM', 'DAUNT', 'DEALT', 'DEBAR',
        'DECAL', 'DECOR', 'DECRY', 'DEFER', 'DEIGN', 'DEITY', 
        'DEMON', 'DEMUR', 'DENSE', 'DERBY', 'DETOX', 'DEUCE', 'DILLY', 'DIMLY',
        'DINGY', 'DIODE', 'DIRGE', 'DIRTY', 'DITCH', 'DITTY', 'DIVER', 'DIZZY', 'DODGY',
        'DOGMA', 'DOPEY', 'DOUGH', 'DOWDY', 'DOWEL', 'DOWNY', 'DRAFT', 'DRAKE', 'DRAMA',
        'DRANK', 'DRAPE', 'DRAWL', 'DREAD', 'DRESS', 'DRIED', 'DRIER', 'DRIFT', 'DRILL',
        'DROIT', 'DRONE', 'DROOL', 'DROSS', 'DROWN', 'DRUID', 'DRUNK', 'DRYER', 'DRYLY',
        'DULLY', 'DUMMY', 'DUMPY', 'DUNCE', 'DUSKY', 'DUSTY', 'DYING', 'EAGER', 'EAGLE',  
        'EATEN', 'EATER', 'ECLAT', 'EDIFY', 'EERIE', 'EIGHT', 'EKING', 'ELATE', 'ELBOW', 'ELECT',
        'ELEGY', 'ELFIN', 'ELIDE', 'ELITE', 'EMBED', 'EMCEE', 'ENDOW', 'ENEMY', 
        'ENTRY', 'ENVOY', 'ERASE', 'ERECT', 'ESTER', 'ETUDE', 'EVICT',
        'EXILE', 'EXTOL', 'EYING', 'FABLE', 'FACET', 'FAIRY', 'FALSE', 'FANCY',
        ...
        'PROOF', 'PROSE', 'PRUDE', 'PUBIC', 'PUDGY', 'PUFFY', 'PULSE', 'PUNCH', 'PUPIL',
        ...
        'RARER', 'RASPY', 'RATTY', 'RAVEN', 'RAZOR', 'REACH', 'REARM', 'REBAR', 
        'RECUT', 'REEDY', 'REFIT', 'REHAB', 'REIGN', 'RELAX', 'RELAY', 'REMIT',
        ...
        'VIPER', 'VIRUS', 'VISIT', 'VISOR', 'VISTA', 'VIXEN', 'VOCAL', 'VOGUE', 'VOILA',
        'VOMIT', 'VOWEL', 'VYING', 'WAFER', 'WAGER', 'WAIST', 'WAIVE', 'WARTY', 'WATER',
        'WAVER', 'WAXEN', 'WEAVE', 'WEEDY', 'WEIGH', 'WELCH', 'WELSH', 'WHARF', 'WHEAT',
        'WHINY', 'WHITE', 'WHOLE', 'WHOSE', 'WIDER', 'WIDOW', 'WIDTH', 'WIELD', 'WIGHT',
